(() => {
  // ns-params:@params
  var baseURL = "";
  var params = { algolia: { appid: "YOUR_KEY", appkey: "YOUR_APP_KEY", enabled: true, searchindex: "YOUR_INDEX" }, blogroll: [{ name: "Apple", url: "https://Apple.com/" }, { name: "Google", url: "https://Google.com/" }], css: [{ url: "css1.css" }, { url: "css2.css" }], defaultcover: "https://s2.loli.net/2023/06/10/njCBimxvZaOowz2.jpg", email: "2904817126@qq.com", js: [{ url: "js1.js" }, { url: "js2.js" }], showcopyright: true, showmore: true, showrss: true, socialmedia: [{ name: "Github", url: "https://github.com" }, { name: "Twitter", url: "https://twitter.com" }] };
